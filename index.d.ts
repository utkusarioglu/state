...
declare module '@utkusarioglu/state' {
    ...
    export { M_State } from "@utkusarioglu/state/Mixins/m_state";
    export { State } from "@utkusarioglu/state/State/state";
    export { i_stateInput } from "@utkusarioglu/state/Common/t_state";
}

declare module '@utkusarioglu/state/Mixins/m_state' {
    import { M_Namespace } from "@utkusarioglu/namespace";
    import { State } from "@utkusarioglu/state/State/state";
    import { i_stateInput } from "@utkusarioglu/state/Common/t_state";
...
declare module '@utkusarioglu/state/State/state' {
    import { t_classStatesList, t_instanceId, t_variableName, t_propertyPath, t_trackRecord, t_trackRecordStack, t_filteringFields, e_filterMode, t_trackRecordSimplified, t_namespace, t_channel, i_map } from "@utkusarioglu/state/Common/t_state";
    export class State {
...
declare module '@utkusarioglu/state/Common/t_state' {
